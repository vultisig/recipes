...
// MessageType represents the type of MAYAChain message
...
const (
	// MsgSend TypeUrls - both standard Cosmos and MAYAChain custom formats
	TypeUrlCosmosMsgSend   = "/cosmos.bank.v1beta1.MsgSend"
	TypeUrlMayachainMsgSend = "/types.MsgSend"

	// MsgDeposit TypeUrls
	TypeUrlMayachainMsgDeposit = "/types.MsgDeposit"
)
...
var typeUrlRegistry = map[string]MessageType{
	...
	TypeUrlMayachainMsgSend:    MessageTypeSend,
	TypeUrlMayachainMsgDeposit: MessageTypeDeposit,
}
