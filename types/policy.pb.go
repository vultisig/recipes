...
type Policy struct {
	...
	Target        *Target `protobuf:"bytes,15,opt,name=target,proto3" json:"target,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_policy_proto_rawDesc = "" +
	...
	"\x12max_txs_per_window\x18\x0e \x01(\rH\x01R\x0fmaxTxsPerWindow\x88\x01\x01\x12%\n" +
	"\x06target\x18\x0f \x01(\v2\r.types.TargetR\x06targetB\x14\n" +
