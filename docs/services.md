...
- Serve policy creation and management endpoints
...
2. **Validation**: Validate job parameters and policy compliance
...
- **Rate Limited**: Ensure compliance with policy rate limits
...
#### 1. HTTP Server for core functionality (reshare, policies, etc.)
For reference, you may use vultisig/dca app
#### 2. TX preparation and proposing logic
Do it in accordance with user's signed policies
